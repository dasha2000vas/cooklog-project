Проверила возможность входа в админку с двух разных компьютеров. Авторизация проходит успешно.
Вашу ошибку 403 при входе в админку воспроизвести не получается.
Заходила под:
* login: admin
* password: admin
